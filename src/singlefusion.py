...
def parse_args():
    parser = argparse.ArgumentParser(
        description='Fusion a sigle model')
...
if __name__ == "__main__":
  ...
  #  work_dir ="/mnt/hdd/tangwei/chongqing/new_mmdet/mmdetection/undersonar/work_dirs/all_cr_dcn_r50_fpn_1x_20200410030400/"
    model_dir_list = [os.path.join(args.work_dir, 'epoch_{}.pth'.format(epoch)) for epoch in epoch_indices]
    ...
    save_dir = os.path.join(args.work_dir, 'epoch_ensemble.pth')
